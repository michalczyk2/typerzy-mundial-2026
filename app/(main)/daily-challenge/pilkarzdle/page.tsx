...
import { PilkarzdleGame } from '@/components/daily/PilkarzdleGame'
import { getPilkarzdlePublicPuzzle } from '@/lib/pilkarzdle'

export const dynamic = 'force-dynamic'

export default function PilkarzdlePage() {
  const puzzle = getPilkarzdlePublicPuzzle()
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 max-w-2xl text-3xl font-black tracking-tight text-white sm:text-4xl">
              Odgadnij pilkarza dnia
            </h1>
            <p className="mt-3 max-w-xl text-sm leading-6 text-gray-400">
              Wpisz pilkarza i porownaj narodowosc, pozycje, lige, klub oraz wiek. Zielony to
              trafienie, zolty blisko, czerwony pudlo.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-emerald-900/60 bg-gray-950/70 p-4 text-left shadow-2xl shadow-emerald-950/20 lg:min-w-64">
            ...
            <p className="mt-2 text-2xl font-black text-white">LoLdle Classic po pilkarsku</p>
