...
export const dailyChallengePreview = {
  ...
  todayLabel: 'Dzisiaj',
  status: 'Etap 5: FootWordle + Piłkarzdle + Quotedle + Clubdle + Transferdle',
  rules: [
...
export const dailyChallengeCategories: DailyChallengeCategory[] = [
  ...
  },
  {
    ...
    status: 'Nie rozpoczęto',
    maxPoints: 100,
    href: '/daily-challenge/transferdle',
    enabled: true,
    accentClass: 'from-violet-500/20 to-violet-900/10 border-violet-800/60',
  },
  {
    id: 'clubdle',
    title: 'Clubdle',
